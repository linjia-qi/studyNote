...
![image-20210923091350952](D:\studyNote\java\day01-Java基础知识\笔记\assets\image-20210923091350952.png)

## 1.4 JRE和JDK

![image-20210923091544110](D:\studyNote\java\day01-Java基础知识\笔记\assets\image-20210923091544110.png)
...
![image](D:\studyNote\java\day01-Java基础知识\笔记\assets\Snipaste_2023-12-07_22-43-32.png)
...
#### 4.2.1 不同进制在代码中的表现形式
   ...
   ![进制](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/进制.png)
...
![进制转换](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/进制转换.png)

#### 4.2.3 二进制转十进制快速转换法：8421快速转换法。

![8421](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/8421.png)

#### 4.2.4 任意进制转十进制：除基取余法。

![进制转换](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/除基.png)

#### 4.2.5 进制转换总结

![总结](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/总结.png)
...
![](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/ascii.png)

* 中文怎么存储？——编码规则的发布。 先查找码表找到对应的数字，再转换成二进制存储在计算机中。

![](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/中文.png)
...
![](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/灰度图.png)

* 彩色图——计算机中的三原色：红绿蓝

![](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/三原色.png)图为计算机的像素点放大后的效果。

* **三原色总结**：

![](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/三原色小结.png)

#### 4.3.3 声音数据：

* 对声波进行采样，每一个点都有对应的数字。

![](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/声音数据.png)

举例：氪金：采样点密集，声音质量高；不氪金：采样点稀疏 ，音质差。

![](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/声音.png)

### 4.4 总结：在计算机中，任意数据都是以二进制形式存储的。

![](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/总结图.png)
...
![](D:/studyNote/java/day02-字面量_标识符_数据类型etc/笔记/img/数据类型.png)
...
<img src="D:\studyNote\java\day03-运算符和表达式\img\运算符.png" style="zoom:50%;" />
...
<img src="D:\studyNote\java\day03-运算符和表达式\img\隐式转换.png" style="zoom:50%;" />
...
* 注意点：
 ...
 2. 强制转换是通过去掉前面的字节来实现的，如图。int 类型的300转换为byte类型变成44；而int 类型的200转换为byte类型变成-56。
    ...
    <img src="D:\studyNote\java\day03-运算符和表达式\img\强制转换.png" style="zoom:50%;" />
...
一个字节（8个bit）为单位，最左边的一位是符号位；反码：为了解决原码不能计算负数的问题而出现。<img src="D:\studyNote\java\day03-运算符和表达式\img\原码反码.png" style="zoom: 33%;" />

### 2. 补码：

* 为了解决反码中0有两种表现形式、出现了两次的问题。（导致每次计算跨0时，结果有1的误差）而出现。

<img src="D:\studyNote\java\day03-运算符和表达式\img\反码.png" style="zoom:40%;" />

* 补码：反码错开一位（去掉了反码中0的负数表现形式，只保留了0的一种表现形式）；负数的补码 = 负数的反码 + 1；

<img src="D:\studyNote\java\day03-运算符和表达式\img\补码.png" style="zoom:40%;" />
...
### 4. -128？
 ...
 <img src="D:\studyNote\java\day03-运算符和表达式\img\-128.png" style="zoom:40%;" />
...
## 2.2 字节层面理解运算符
   ...
   <img src="D:\studyNote\java\day03-运算符和表达式\img\与或非.png" style="zoom:50%;" />

### 1. 两个数字“逻辑与”操作

   <img src="D:\studyNote\java\day03-运算符和表达式\img\数字与.png" style="zoom:33%;" />

### 2. 两个数字“逻辑或”操作

   <img src="D:\studyNote\java\day03-运算符和表达式\img\数字或.png" style="zoom:50%;" />

### 3. 左移运算符（左移1位相当于×2，左移2位相当于×4）

   a << 2  代表将左移两位，低位补0即可。

   <img src="D:\studyNote\java\day03-运算符和表达式\img\左移.png" style="zoom:40%;" />
...
### 4. 右移（右移1位相当于除2，右移2位相当于除4）
   ...
   <img src="D:\studyNote\java\day03-运算符和表达式\img\右移.png" style="zoom:40%;" />

### 5. 无符号右移

   向右移动，高位补0。

   <img src="D:\studyNote\java\day03-运算符和表达式\img\无符号.png" style="zoom:50%;" />
...
![1545615769372](D:/studyNote/java/day04-判断和循环/img/1545615769372.png)
...
![1545616039363](D:/studyNote/java/day04-判断和循环/img/1545616039363.png)
...
![1545616221283](D:/studyNote/java/day04-判断和循环/img/1545616221283.png)
...
![1545616667104](D:/studyNote/java/day04-判断和循环/img/1545616667104.png)
